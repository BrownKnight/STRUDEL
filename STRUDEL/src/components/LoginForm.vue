    ...
    <b-row align-h="center">
      <b-form @submit.prevent="login">
        ...
        <b-input-group class="mr-2 my-3" prepend="Email">
          <b-form-input id="input-email" v-model.number="emailAddress" required></b-form-input>
        </b-input-group>

        <label class="sr-only" id="input-label-password" for="input-password">Password</label>
        <b-input-group class="my-3" prepend="Password">
          <b-form-input id="input-password" v-model="password" type="password" required></b-form-input>
        </b-input-group>
